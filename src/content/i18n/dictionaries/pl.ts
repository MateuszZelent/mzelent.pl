...
export const dictionaryPl: TranslationDictionary = {
  ...
  blogPage: {
    tag: "KRONIKA BADAŃ & GALERIA WIZUALNA",
    heading: "Notatki Laboratoryjne",
    headingAccent: "i Obrazy Mikroskopowe",
    lead: "Dynamiczna pionowa galeria układów doświadczalnych, symulacji mikromagnetycznych GPU, nanofabrykacji w cleanroomie oraz bieżących prac badawczych.",
    backToHome: "← Powrót do Strony Głównej",
    allCategories: "Wszystkie wpisy",
    categoryLab: "Laboratorium",
    categorySim: "Symulacje",
    categoryConf: "Konferencje",
    categoryTheory: "Teoria",
    categoryEquip: "Aparatura",
    adminStudioLink: "Panel Mediów Admin",
    technicalSpecs: "Parametry Techniczne",
    lightboxClose: "Zamknij powiększenie (Esc)",
    noPosts: "Brak wpisów dla wybranej kategorii filtrów.",
  },
};

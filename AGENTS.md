...
During Phase 0, commands that do not yet exist are not required. The Phase 1 scaffold must create the canonical `pnpm` scripts before application work begins.
